...
@tf.function
def assimilation(empires, colonies, num_of_colonies, dimension, direct_assimilation, lower, upper):
    difference = tf.subtract(empires, colonies)
    uniform = helpers.calculate_distribution((num_of_colonies, dimension),
                                             constants.zero,
